...
protected:
	...
	/** Update All pins based on logic. Return value is if any pins were updated. */
	virtual bool UpdatePins() { return false; }
	
	/** Set the value of `AdvancedPinDisplay` on the node */
	void SetNodeHasAdvanced(const bool bHasAdvanced);

	/** Break pins based on condition */
	static UEdGraphPin* BreakPinLinksIf(UEdGraphPin* Pin, const bool bBreak = false);

	/** Pin Getters */
	virtual UEdGraphPin* GetProviderPin() const;
	virtual UEdGraphPin* GetInputPin() const;
	virtual UEdGraphPin* GetWalletPin() const;
	virtual UEdGraphPin* GetSignaturePin() const;
