...
#include "AsyncTasks/Engine/Marketplace/DirectListings/AsyncTaskDirectListingsRevokeReservedBuyerApproval.h"

#include "Components/SlateWrapperTypes.h"
#include "Engine/ThirdwebEngine.h"
#include "Engine/Marketplace/ThirdwebMarketplace.h"

UAsyncTaskDirectListingsRevokeReservedBuyerApproval* UAsyncTaskDirectListingsRevokeReservedBuyerApproval::RevokeReservedBuyerApproval(
...
UAsyncTaskDirectListingsRevokeReservedBuyerApproval* UAsyncTaskDirectListingsRevokeReservedBuyerApproval::MarketplaceRevokeReservedBuyerApproval(
	UObject* WorldContextObject,
...
void UAsyncTaskDirectListingsRevokeReservedBuyerApproval::Activate()
{
