...
#include "AsyncTasks/Engine/Marketplace/EnglishAuctions/AsyncTaskEnglishAuctionsCloseForBidder.h"

#include "Components/SlateWrapperTypes.h"
#include "Engine/ThirdwebEngine.h"
#include "Engine/Marketplace/ThirdwebMarketplace.h"

UAsyncTaskEnglishAuctionsCloseForBidder* UAsyncTaskEnglishAuctionsCloseForBidder::CloseForBidder(
...
UAsyncTaskEnglishAuctionsCloseForBidder* UAsyncTaskEnglishAuctionsCloseForBidder::MarketplaceCloseForBidder(
	UObject* WorldContextObject,
...
void UAsyncTaskEnglishAuctionsCloseForBidder::Activate()
{
