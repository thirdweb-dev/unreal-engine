...
namespace Thirdweb
{
	...
	extern "C"
	{
		...
		FFIResult create_ecosystem_wallet(const char* ecosystem_id, const char* ecosystem_partner_id, const char* client_id,
			const char* bundle_id, const char* secret_key, const char* email, const char* phone, const char* storage_directory_path,
		...
		FFIResult ecosystem_wallet_link_account(uintptr_t handle_id, uintptr_t wallet_to_link_handle_id, const char* otp,
			const char* oauth_result, const char* jwt, const char* payload, const char* session_id, const char* siwe_payload,
		...
		FFIResult create_smart_wallet(const char* client_id, const char* bundle_id, const char* secret_key,
			uintptr_t personal_wallet_handle_id, const char* chain_id, bool gasless, const char* factory, const char* account_override);
		...
		FFIResult smart_wallet_create_session_key(uintptr_t handle_id, const char* signer_address, const char* const* approved_targets,
			uintptr_t approved_targets_count, const char* native_token_limit_per_transaction_in_wei,
			uint64_t permission_start_timestamp, uint64_t permission_end_timestamp, uint64_t req_validity_start_timestamp,
