...
#include "AsyncTaskDirectListingsGetAll.generated.h"
...
class THIRDWEB_API UAsyncTaskDirectListingsGetAll : public UAsyncTaskMarketplaceGetBase
{
	GENERATED_BODY()
...
public:
	...
	static UAsyncTaskDirectListingsGetAll* GetAll(
	...
	static UAsyncTaskDirectListingsGetAll* MarketplaceGetAll(
		UObject* WorldContextObject,
