...
#include "AsyncTaskEnglishAuctionsExecuteSale.generated.h"
...
class THIRDWEB_API UAsyncTaskEnglishAuctionsExecuteSale : public UAsyncTaskMarketplacePostBase
{
	GENERATED_BODY()
...
public:
	...
	static UAsyncTaskEnglishAuctionsExecuteSale* ExecuteSale(
	...
	static UAsyncTaskEnglishAuctionsExecuteSale* MarketplaceExecuteSale(
		UObject* WorldContextObject,
